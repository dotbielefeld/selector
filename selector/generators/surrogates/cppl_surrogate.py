...
class CPPL:
    ...
    def select_from_set(self, conf_set, instance_set, n_to_select):
        ...
        selection = qual_sort[:n_to_select]  # (-quality).argsort()[:n_to_select]
        return [conf_set[i] for i in selection], [[v_hat_s[i], confidence_s[i]] for i in qual_sort]  # (-quality).argsort() ]
