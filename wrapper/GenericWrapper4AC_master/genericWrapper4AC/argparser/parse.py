...
import os
import typing
import wrapper.GenericWrapper4AC_master.genericWrapper4AC

from argparse import ArgumentParser, ArgumentDefaultsHelpFormatter, SUPPRESS

from wrapper.GenericWrapper4AC_master.genericWrapper4AC.data.data import Data
...
def get_parser():
    ...
    parser.add_argument("--runsolver-path", dest="runsolver", default=os.path.join(wrapper.GenericWrapper4AC_master.genericWrapper4AC.__path__[
